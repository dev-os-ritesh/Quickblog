  ...
  return (
    <form  onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50  text-gray-600 h-full overflow-scroll ' >
      ...
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <input type="text" placeholder='Type here' value={Title} onChange={(e)=>setTitle(e.target.value)} required className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' />

        <p className='mt-4'>Blog SubTitle</p>
        <input type="text" placeholder='Type here' value={Subtitle} onChange={(e)=>setSubtitle(e.target.value)} required className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' />
